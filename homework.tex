...
\ifx\headerrulewidth\undefined
    \def\headerrulewidth{2px}
\else
\fi
...
\fancypagestyle{footonly}{%
    ...
    \renewcommand{\footrulewidth}{\headerrulewidth}% 2pt header rule
...
\fancypagestyle{plain}{%
    ...
    \fancyhead[C]{\thetitle}
    \renewcommand{\headrulewidth}{\headerrulewidth}% 2pt header rule
